...
PRODUCT_COPY_FILES += \
    ...
    vendor/xiaomi/picasso/proprietary/vendor/etc/thermal-per-camera.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-per-camera.conf \
    vendor/xiaomi/picasso/proprietary/vendor/etc/thermal-per-normal.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-per-normal.conf \
...
PRODUCT_PACKAGES += \
    ...
    fingerprint.fpc.lito \
    fingerprint.goodix.lito \
